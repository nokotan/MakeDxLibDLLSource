...
namespace DxLibDLL
{
	public static class DX
	{
		...
		{
				return dx_SetASyncLoadFinishDeleteFlag( Handle );
		}
		...
		{
				return dx_SetASyncLoadThreadNum( ThreadNum );
		}
...
#if DX_USE_UNSAFE
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		extern unsafe static int  dx_GetHostIPbyName( string  HostName, IPDATA *  IPDataBuf, int  IPDataBufLength, int *  IPDataGetNum);
		public unsafe static int  GetHostIPbyName( string  HostName, IPDATA *  IPDataBuf, int  IPDataBufLength, int *  IPDataGetNum)
		{
				return dx_GetHostIPbyName( HostName , IPDataBuf , IPDataBufLength , IPDataGetNum );
		}
#endif

#if DX_USE_UNSAFE
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		extern unsafe static int  dx_GetHostIPbyNameWithStrLen( string  HostName, ulong  HostNameLength, IPDATA *  IPDataBuf, int  IPDataBufLength, int *  IPDataGetNum);
		...
		{
				return dx_GetHostIPbyNameWithStrLen( HostName , HostNameLength , IPDataBuf , IPDataBufLength , IPDataGetNum );
		}
#endif

#if DX_USE_UNSAFE
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		extern unsafe static int  dx_GetHostIPbyName_IPv6( string  HostName, IPDATA_IPv6 *  IPDataBuf, int  IPDataBufLength, int *  IPDataGetNum);
		public unsafe static int  GetHostIPbyName_IPv6( string  HostName, IPDATA_IPv6 *  IPDataBuf, int  IPDataBufLength, int *  IPDataGetNum)
		{
				return dx_GetHostIPbyName_IPv6( HostName , IPDataBuf , IPDataBufLength , IPDataGetNum );
		}
#endif

#if DX_USE_UNSAFE
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		extern unsafe static int  dx_GetHostIPbyName_IPv6WithStrLen( string  HostName, ulong  HostNameLength, IPDATA_IPv6 *  IPDataBuf, int  IPDataBufLength, int *  IPDataGetNum);
		...
		{
				return dx_GetHostIPbyName_IPv6WithStrLen( HostName , HostNameLength , IPDataBuf , IPDataBufLength , IPDataGetNum );
		}
#endif
...
#if DX_USE_UNSAFE
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		extern unsafe static int  dx_GetMyIPAddress( IPDATA *  IpBuf, int  IpBufLength, int *  IpNum);
		public unsafe static int  GetMyIPAddress( IPDATA *  IpBuf, int  IpBufLength, int *  IpNum)
		{
				return dx_GetMyIPAddress( IpBuf , IpBufLength , IpNum );
		}
#endif

#if DX_USE_UNSAFE
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		extern unsafe static int  dx_GetMyIPAddress_IPv6( IPDATA_IPv6 *  IpBuf, int  IpBufLength, int *  IpNum);
		public unsafe static int  GetMyIPAddress_IPv6( IPDATA_IPv6 *  IpBuf, int  IpBufLength, int *  IpNum)
		{
				return dx_GetMyIPAddress_IPv6( IpBuf , IpBufLength , IpNum );
		}
#endif
...
#if DX_USE_UNSAFE
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		extern unsafe static int  dx_NetWorkRecvUDP( int  NetUDPHandle, IPDATA *  RecvIP, int *  RecvPort, System.IntPtr  Buffer, int  Length, int  Peek);
...
#if DX_USE_UNSAFE
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		extern unsafe static int  dx_NetWorkRecvUDP_IPv6( int  NetUDPHandle, IPDATA_IPv6 *  RecvIP, int *  RecvPort, System.IntPtr  Buffer, int  Length, int  Peek);
		...
		{
				return dx_DrawIMEInputString( x , y , SelectStringNum , TRUE );
		}
		public static int  DrawIMEInputString( int  x, int  y, int  SelectStringNum, int  DrawCandidateList)
		{
				return dx_DrawIMEInputString( x , y , SelectStringNum , DrawCandidateList );
		}
		...
		{
				return dx_InputStringToCustom( x , y , BufLength , StrBuffer , CancelValidFlag , SingleCharOnlyFlag , NumCharOnlyFlag , FALSE , FALSE , TRUE );
		}
		...
		{
				return dx_InputStringToCustom( x , y , BufLength , StrBuffer , CancelValidFlag , SingleCharOnlyFlag , NumCharOnlyFlag , DoubleCharOnlyFlag , FALSE , TRUE );
		}
		...
		{
				return dx_InputStringToCustom( x , y , BufLength , StrBuffer , CancelValidFlag , SingleCharOnlyFlag , NumCharOnlyFlag , DoubleCharOnlyFlag , EnableNewLineFlag , TRUE );
		}
		...
		{
				return dx_InputStringToCustom( x , y , BufLength , StrBuffer , CancelValidFlag , SingleCharOnlyFlag , NumCharOnlyFlag , DoubleCharOnlyFlag , EnableNewLineFlag , DisplayCandidateList );
		}
		...
		{
				return dx_SetKeyInputStringColor2( TargetColor , Color );
		}
		...
		{
				return dx_ResetKeyInputStringColor2( TargetColor );
		}
		...
		{
				return dx_SetKeyInputStringEndCharaMode( EndCharaMode );
		}
		...
		{
				return dx_MakeKeyInput( MaxStrLength , CancelValidFlag , SingleCharOnlyFlag , NumCharOnlyFlag , FALSE , FALSE );
		}
		...
		{
				return dx_MakeKeyInput( MaxStrLength , CancelValidFlag , SingleCharOnlyFlag , NumCharOnlyFlag , DoubleCharOnlyFlag , FALSE );
		}
		...
		{
				return dx_MakeKeyInput( MaxStrLength , CancelValidFlag , SingleCharOnlyFlag , NumCharOnlyFlag , DoubleCharOnlyFlag , EnableNewLineFlag );
		}
		...
		{
				return dx_DrawKeyInputString( x , y , InputHandle , TRUE );
		}
		public static int  DrawKeyInputString( int  x, int  y, int  InputHandle, int  DrawCandidateList)
		{
				return dx_DrawKeyInputString( x , y , InputHandle , DrawCandidateList );
		}
		...
		{
				return dx_SetKeyInputDrawArea( x1 , y1 , x2 , y2 , InputHandle );
		}
		...
		{
				return dx_SetKeyInputStringWithStrLen( String , StringLength , InputHandle );
		}
		...
		{
				return dx_CreateDivGraphFromSoftImage( SIHandle , AllNum , XNum , YNum , SizeX , SizeY , HandleArray );
		}
		...
		{
				return dx_CreateDivGraphFFromSoftImage( SIHandle , AllNum , XNum , YNum , SizeX , SizeY , HandleArray );
		}
		...
		{
				return dx_ReCreateDivGraphFromSoftImage( SIHandle , AllNum , XNum , YNum , SizeX , SizeY , HandleArray );
		}
		...
		{
				return dx_ReCreateDivGraphFFromSoftImage( SIHandle , AllNum , XNum , YNum , SizeX , SizeY , HandleArray );
		}
		...
		{
				return dx_PlayMovieWithStrLen( FileName , FileNameLength , ExRate , PlayType );
		}
		...
		{
				return dx_GetMovieImageSize_File( FileName , out SizeX , out SizeY );
		}
		...
		{
				return dx_GetMovieImageSize_File_WithStrLen( FileName , FileNameLength , out SizeX , out SizeY );
		}
		...
		{
				return dx_GetMovieImageSize_Mem( FileImage , FileImageSize , out SizeX , out SizeY );
		}
		...
		{
				return dx_OpenMovieToGraphWithStrLen( FileName , FileNameLength , TRUE );
		}
		public static int  OpenMovieToGraphWithStrLen( string  FileName, ulong  FileNameLength, int  FullColor)
		{
				return dx_OpenMovieToGraphWithStrLen( FileName , FileNameLength , FullColor );
		}
		...
		{
				return dx_SetPlaySpeedRateMovieToGraph( GraphHandle , SpeedRate );
		}
		...
		{
				return dx_SetMovieColorA8R8G8B8Flag( Flag );
		}
		...
		{
				return dx_SetMovieUseYUVFormatSurfaceFlag( Flag );
		}
		...
		{
				return dx_ReadJpegExif( JpegFilePath , ExifBuffer_Array , ExifBufferSize );
		}
		...
		{
				return dx_ReadJpegExifWithStrLen( JpegFilePath , JpegFilePathLength , ExifBuffer_Array , ExifBufferSize );
		}
		...
		{
				return dx_LoadSoftImageWithStrLen( FileName , FileNameLength );
		}
		...
		{
				return dx_LoadARGB8ColorSoftImage( FileName );
		}
		...
		{
				return dx_LoadARGB8ColorSoftImageWithStrLen( FileName , FileNameLength );
		}
		...
		{
				return dx_LoadXRGB8ColorSoftImage( FileName );
		}
		...
		{
				return dx_LoadXRGB8ColorSoftImageWithStrLen( FileName , FileNameLength );
		}
		...
		{
				return dx_LoadARGB8ColorSoftImageToMem( FileImage , FileImageSize );
		}
		...
		{
				return dx_LoadXRGB8ColorSoftImageToMem( FileImage , FileImageSize );
		}
		...
		{
				return dx_MakeARGBF32ColorSoftImage( SizeX , SizeY );
		}
		...
		{
				return dx_MakeARGBF16ColorSoftImage( SizeX , SizeY );
		}
		...
		{
				return dx_MakeA1R5G5B5ColorSoftImage( SizeX , SizeY );
		}
		...
		{
				return dx_MakeX1R5G5B5ColorSoftImage( SizeX , SizeY );
		}
		...
		{
				return dx_MakeR5G5B5A1ColorSoftImage( SizeX , SizeY );
		}
		...
		{
				return dx_MakeR5G6B5ColorSoftImage( SizeX , SizeY );
		}
		...
		{
				return dx_MakePAL8ColorSoftImage( SizeX , SizeY , FALSE );
		}
		public static int  MakePAL8ColorSoftImage( int  SizeX, int  SizeY, int  UseAlpha)
		{
				return dx_MakePAL8ColorSoftImage( SizeX , SizeY , UseAlpha );
		}
		...
		{
				return dx_GetDrawScreenSoftImageDestPos( x1 , y1 , x2 , y2 , SIHandle , DestX , DestY );
		}
		...
		{
				return dx_GetPitchSoftImage( SIHandle );
		}
		...
		{
				return dx_DrawPixelSoftImageF( SIHandle , x , y , r , g , b , a );
		}
		...
		{
				return dx_GetPixelSoftImageF( SIHandle , x , y , out r , out g , out b , out a );
		}
		...
		{
				return dx_DrawCircleSoftImage( SIHandle , x , y , radius , r , g , b , a , TRUE );
		}
		public static int  DrawCircleSoftImage( int  SIHandle, int  x, int  y, int  radius, int  r, int  g, int  b, int  a, int  FillFlag)
		{
				return dx_DrawCircleSoftImage( SIHandle , x , y , radius , r , g , b , a , FillFlag );
		}
		...
		{
				return dx_BltStringSoftImageWithStrLen( x , y , StrData , StrDataLength , DestSIHandle , -1 , FALSE );
		}
		...
		{
				return dx_BltStringSoftImageWithStrLen( x , y , StrData , StrDataLength , DestSIHandle , DestEdgeSIHandle , FALSE );
		}
		...
		{
				return dx_BltStringSoftImageWithStrLen( x , y , StrData , StrDataLength , DestSIHandle , DestEdgeSIHandle , VerticalFlag );
		}
		...
		{
				return dx_BltStringSoftImageToHandleWithStrLen( x , y , StrData , StrDataLength , DestSIHandle , DestEdgeSIHandle , FontHandle , FALSE );
		}
		...
		{
				return dx_BltStringSoftImageToHandleWithStrLen( x , y , StrData , StrDataLength , DestSIHandle , DestEdgeSIHandle , FontHandle , VerticalFlag );
		}
		...
		{
				return dx_SaveSoftImageToBmpWithStrLen( FilePath , FilePathLength , SIHandle );
		}
		...
		{
				return dx_SaveSoftImageToDds( FilePath , SIHandle );
		}
		...
		{
				return dx_SaveSoftImageToDdsWithStrLen( FilePath , FilePathLength , SIHandle );
		}
		...
		{
				return dx_SaveSoftImageToPngWithStrLen( FilePath , FilePathLength , SIHandle , CompressionLevel );
		}
		...
		{
				return dx_SaveSoftImageToJpegWithStrLen( FilePath , FilePathLength , SIHandle , Quality , Sample2x1 );
		}
		...
		{
				return dx_Live2D_SetCubism4CoreDLLPath( CoreDLLFilePath );
		}
		...
		{
				return dx_Live2D_SetCubism4CoreDLLPathWithStrLen( CoreDLLFilePath , CoreDLLFilePathLength );
		}
		...
		{
				return dx_Live2D_SetCubism3CoreDLLPath( CoreDLLFilePath );
		}
		...
		{
				return dx_Live2D_SetCubism3CoreDLLPathWithStrLen( CoreDLLFilePath , CoreDLLFilePathLength );
		}
		...
		{
				return dx_Live2D_LoadModel( FilePath );
		}
		...
		{
				return dx_Live2D_LoadModelWithStrLen( FilePath , FilePathLength );
		}
		...
		{
				return dx_Live2D_DeleteModel( Live2DModelHandle );
		}
		...
		{
				return dx_Live2D_Model_Update( Live2DModelHandle , DeltaTimeSeconds );
		}
		...
		{
				return dx_Live2D_Model_SetTranslate( Live2DModelHandle , x , y );
		}
		...
		{
				return dx_Live2D_Model_SetExtendRate( Live2DModelHandle , ExRateX , ExRateY );
		}
		...
		{
				return dx_Live2D_Model_SetRotate( Live2DModelHandle , RotAngle );
		}
		...
		{
				return dx_Live2D_Model_Draw( Live2DModelHandle );
		}
		...
		{
				return dx_Live2D_Model_StartMotion( Live2DModelHandle , group , no );
		}
		...
		{
				return dx_Live2D_Model_StartMotionWithStrLen( Live2DModelHandle , group , groupLength , no );
		}
		...
		{
				return dx_Live2D_Model_IsMotionFinished( Live2DModelHandle );
		}
		...
		{
				return dx_Live2D_Model_SetExpression( Live2DModelHandle , expressionID );
		}
		...
		{
				return dx_Live2D_Model_SetExpressionWithStrLen( Live2DModelHandle , expressionID , expressionIDLength );
		}
		...
		{
				return dx_Live2D_Model_HitTest( Live2DModelHandle , hitAreaName , x , y );
		}
		...
		{
				return dx_Live2D_Model_HitTestWithStrLen( Live2DModelHandle , hitAreaName , hitAreaNameLength , x , y );
		}
		...
		{
				return dx_Live2D_Model_GetParameterCount( Live2DModelHandle );
		}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetParameterId( Live2DModelHandle , index );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
		...
		{
				return dx_Live2D_Model_GetParameterValue( Live2DModelHandle , parameterId );
		}
		...
		{
				return dx_Live2D_Model_GetParameterValueWithStrLen( Live2DModelHandle , parameterId , parameterIdLength );
		}
		...
		{
				return dx_Live2D_Model_SetParameterValue( Live2DModelHandle , parameterId , value );
		}
		...
		{
				return dx_Live2D_Model_SetParameterValueWithStrLen( Live2DModelHandle , parameterId , parameterIdLength , value );
		}
		...
		{
				return dx_Live2D_Model_GetHitAreasCount( Live2DModelHandle );
		}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetHitAreaName( Live2DModelHandle , index );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetPhysicsFileName( Live2DModelHandle );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetPoseFileName( Live2DModelHandle );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
		...
		{
				return dx_Live2D_Model_GetExpressionCount( Live2DModelHandle );
		}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetExpressionName( Live2DModelHandle , index );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetExpressionFileName( Live2DModelHandle , index );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
		...
		{
				return dx_Live2D_Model_GetMotionGroupCount( Live2DModelHandle );
		}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetMotionGroupName( Live2DModelHandle , index );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
		...
		{
				return dx_Live2D_Model_GetMotionCount( Live2DModelHandle , groupName );
		}
		...
		{
				return dx_Live2D_Model_GetMotionCountWithStrLen( Live2DModelHandle , groupName , groupNameLength );
		}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetMotionFileName( Live2DModelHandle , groupName , index );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetMotionFileNameWithStrLen( Live2DModelHandle , groupName , groupNameLength , index );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetMotionSoundFileName( Live2DModelHandle , groupName , index );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetMotionSoundFileNameWithStrLen( Live2DModelHandle , groupName , groupNameLength , index );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
		...
		{
				return dx_Live2D_Model_GetMotionFadeInTimeValue( Live2DModelHandle , groupName , index );
		}
		...
		{
				return dx_Live2D_Model_GetMotionFadeInTimeValueWithStrLen( Live2DModelHandle , groupName , groupNameLength , index );
		}
		...
		{
				return dx_Live2D_Model_GetMotionFadeOutTimeValue( Live2DModelHandle , groupName , index );
		}
		...
		{
				return dx_Live2D_Model_GetMotionFadeOutTimeValueWithStrLen( Live2DModelHandle , groupName , groupNameLength , index );
		}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetUserDataFile( Live2DModelHandle );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
		...
		{
				return dx_Live2D_Model_GetEyeBlinkParameterCount( Live2DModelHandle );
		}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetEyeBlinkParameterId( Live2DModelHandle , index );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
		...
		{
				return dx_Live2D_Model_GetLipSyncParameterCount( Live2DModelHandle );
		}
		...
		{
				System.IntPtr resultIntPtr = dx_Live2D_Model_GetLipSyncParameterId( Live2DModelHandle , index );
				if( resultIntPtr == System.IntPtr.Zero )
				{
					return "";
				}
